...
public class Constants {
   ...
   public static final String[] SFTypes = { "ApexClass", "ApexComponent",
			...
			"Settings", "SharingRules", "StaticResource", "WebLink", "CustomPageWebLink", "Workflow", "Queue",
